...
int pl(BSTPTR T1,int a){
    static int i=0;
    if(a>T1->data){i++;return pl(T1->rchild,a);}
    else if(a<T1->data){i++;return pl(T1->lchild,a);}
    else return i;
}

BSTPTR pt(BSTPTR T1,int a){
    if(a>T1->data){return pt(T1->rchild,a);}
    else if(a<T1->data){return pt(T1->lchild,a);}
    else return T1;
}
...
int main()
{
    ...
    cout << "Enter the numbers whose path you want to find." << endl;
    int a1,a2;
    cin >> a1 >> a2;
